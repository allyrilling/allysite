          ...
          />{' '} */}
				...
				<Navbar.Collapse id='responsive-navbar-nav'>
					<Nav className='ml-auto'>
						<Nav.Link href='Home' className='linkHover'>
							Home
						</Nav.Link>
						<Nav.Link href='Resume' className='linkHover'>
							Resume
						</Nav.Link>
						<Nav.Link href='Projects' className='linkHover'>
							Projects
						</Nav.Link>
						<Nav.Link href='designportfolio' className='linkHover'>
							Design Portfolio
						</Nav.Link>
					</Nav>
				</Navbar.Collapse>
