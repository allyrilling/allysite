	...
	return (
		<Container>
			<Col>
				...
				<Row className='rowContainer'>
					<Col className='projectMini'>
						<a href='/projects/options-visualizer'>
							<ProjectMini icon={ovLogo} name='Options Visualizer' description='Website' />
						</a>
					</Col>
					<Col className='projectMini'>
						<a href='/projects/fintools'>
							<ProjectMini icon={ftlogo} name='FinTools' description='Website' />
						</a>
					</Col>
					<Col className='projectMini'>
						<a href='/projects/flowerdictionary'>
							<ProjectMini icon={fdlogo} name='Flower Dictionary' description='Website' />
						</a>
					</Col>
					<Col className='projectMini'>
						<a href='/projects/penguinworkouts'>
							<ProjectMini icon={icon} name='Penguin Workouts' description='iOS App' />
						</a>
					</Col>
					<Col className='projectMini'>
						<a href='/projects/lightyear'>
        ...
        <Row>
          ...
          <a href="/projects/"><ProjectMini icon={icon} name="Loop Icons" description="Alternate icons for Loop." /></a>
				...
				<Row className='rowContainer'>
					<Col className='projectMini'>
						<a href='/projects/cs559'>
							<ProjectMini icon={gralogo} name='Graphics Projects' description='CS559 Class Projects' />
						</a>
					</Col>
					<Col className='projectMini'>
						<a href='/projects/reactnative'>
							<ProjectMini icon={rnlogo} name='React Native ɑ/β' description='CS571 Class Project' />
						</a>
					</Col>
					<Col className='projectMini'>
						<a href='/projects/dialogflow'>
							{' '}
					...
					<Col className='projectMini'>
						<a href='/projects/cs570'>
							<ProjectMini icon={iplogo} name='High Fidelity Prototypes' description='CS570 Class Projects' />
						</a>
					</Col>
					<Col className='projectMini'>
						<a href='/projects/javascript'>
